        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">{t('multiAgent.selectScenario')}</h2>
                ...
                {scenarios.map((s) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-800">{t(`multiAgent.scenarios.${s.id}.name`)}</div>
                      <div className="text-sm text-gray-600 mt-1">{t(`multiAgent.scenarios.${s.id}.desc`)}</div>
                    </div>
                  </label>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">{t('multiAgent.transactionParams')}</h2>
                ...
                {(scenario === 'secondary' || scenario === 'complete') && (
                  <div>
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="mt-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:opacity-50 text-sm"
                    >
                      {t('buttons.addSigner')}
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex justify-between items-center mb-4 border-b border-gray-200 pb-4">
                <h3 className="text-xl font-bold text-gray-800">{t('multiAgent.codeExample')}</h3>
          ...
          <div className="space-y-6">
            {transaction ? (
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h2 className="text-xl font-bold text-gray-800 mb-4">{t('multiAgent.results.transactionDetails')}</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.transactionType')}</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.sender')}</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.secondarySigners')}</h3>
                  ...
                  {transaction.feePayerAddress && (
                    <div>
                      <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.feePayer')}</h3>
                      <div className="bg-purple-50 p-3 rounded-lg font-mono text-sm text-purple-800">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.sequenceNumber')}</h3>
                    <div className="bg-gray-50 p-3 rounded-lg font-mono text-sm">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.gasUnitPrice')}</h3>
                    <div className="bg-gray-50 p-3 rounded-lg font-mono text-sm">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-2">{t('multiAgent.results.maxGasAmount')}</h3>
                    <div className="bg-gray-50 p-3 rounded-lg font-mono text-sm">
                  ...
                  <details className="border border-gray-200 rounded-lg overflow-hidden">
                    <summary className="bg-gray-50 px-4 py-3 cursor-pointer font-medium text-purple-600 hover:bg-gray-100">
